...
public class GraficaAdmin extends JFrame {
	...
	private static String rutaCompuestos;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GraficaAdmin frame = new GraficaAdmin(rutaIniciales, rutaCompuestos, rutaPersonajes);
	 ...
	 * Create the frame.
	 */
	public GraficaAdmin(String rutaIniciales, String rutaCompuestos, String rutaPersonajes) {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if (!tf_codigoInicial.equals("") && !tf_nombreInicial.equals("")) {
						ElementoInicial nuevo = new ElementoInicial(tf_codigoInicial.getText(),
								tf_nombreInicial.getText());
		...
		bt_addCompuesto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!tf_codigoCompuesto.getText().equals("") && !tf_nombreCompuesto.getText().equals("")
						&& !tf_codigoAccesoCompuesto.getText().equals("")) {
					ElementoCompuesto aux = new ElementoCompuesto(tf_codigoCompuesto.getText(),
							tf_nombreCompuesto.getText(), tf_codigoAccesoCompuesto.getText());
		...
		bt_addPersonaje.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!tf_codigoCompuesto.getText().equals("") && !tf_nombreCompuesto.getText().equals("")
						&& !tf_codigoAccesoCompuesto.getText().equals("")) {
					Personaje aux = new Personaje(tf_codigoCompuesto.getText(), tf_nombreCompuesto.getText(),
							tf_codigoAccesoCompuesto.getText());
